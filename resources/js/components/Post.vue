<template>
  <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
    ...
    <div class="flex justify-between text-gray-700 text-sm pt-2 px-4">
      <div class="flex">
        ...
        <p class="ml-1">
          ...
          <span
            v-if="post.data.attributes.likes.like_count === 1"
          >like</span>
    ...
    <div class="flex justify-between border-1 border-gray-400 m-4">
      <button
        ...
        :class="[post.data.attributes.likes.user_likes_post ? 'bg-blue-500 text-white' : '']"

<template>
  <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        ...
        <div class="ml-2">
          <div class="ml-2 relative">
            ...
            <input
              type="text"
              name="search"
              class="rounded-md pl-8 w-56 bg-gray-200 h-8 focus:outline-none focus:shadow-outline text-sm"
              placeholder="Search"
            />
          </div>
        </div>
    ...
    <div class="w-1/3 flex justify-center items-center h-full">
      <router-link to="/" class="px-6 border-b-2 border-blue-600 h-full flex items-center">
